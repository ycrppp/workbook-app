...
- Упражнение 3 (Следующий шаг): одно конкретное действие которое пользователь сделает на этой неделе. В тексте задания никогда не пиши "упражнение 1" или "упражнение 2" — пиши конкретно: "замысел который ты только что написал".
