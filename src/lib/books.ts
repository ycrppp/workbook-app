...
ФОКУС МОДУЛЯ: культура инициативы и самостоятельного действия в рамках замысла. Никогда не используй примеры про "войска" и армию — переводи в реальность бизнеса или роли пользователя.`,
      },
    ],
  },
};
