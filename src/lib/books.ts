...
Инструмент: пользователь называет конкретную неправильную реакцию которую применяет к этому разрыву — и разбирает какое трение она создаёт именно в его бизнесе. Результат — текст который он может использовать.
Следующий шаг: одно конкретное действие на этой неделе — где именно он применит другую реакцию на этот разрыв. Конкретная ситуация + конкретный день. Если действие связано с другим человеком — называет кого. Если это личное поведенческое изменение — просто ситуация и день без обязательного человека. Формат: что сделает + когда + (кому, если есть).`,
      },
      {
        id: 'intent',
...
ПРИМЕНЕНИЕ К ТРЁМ УПРАЖНЕНИЯМ (все три про боль пользователя):
Диагностика: пользователь смотрит на свою конкретную боль и находит где он сам сейчас ставит инструкции вместо замысла — 2-3 конкретных примера из его реальной практики с конкретными людьми или ситуациями.
...
Следующий шаг: берёт замысел который написал выше и использует его в одной конкретной ситуации на этой неделе — вместо инструкции которую обычно даёт. Конкретная ситуация + конкретный день. Формат: в какой момент + что именно сделает по-другому.`,
      },
      {
        id: 'cascade',
        title: 'Каскад целей',
...
Следующий шаг: одно конкретное решение которое он передаст на этой неделе с замыслом вместо инструкции — кому-то из команды, подрядчиков или партнёров в зависимости от его контекста. Кому конкретно, что, в каком формате.`,
      },
      {
        id: 'independence',
