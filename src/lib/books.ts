...
Следующий шаг: берёт замысел который написал выше и передаёт его одному конкретному человеку — отправляет сообщение, или говорит на встрече, или называет на звонке. Конкретный человек + конкретный день. Формат: что сделает + кому + когда.`,
      },
      {
        id: 'cascade',
        title: 'Каскад целей',
