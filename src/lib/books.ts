...
Следующий шаг: один конкретный разговор или действие на этой неделе — где именно он применит другую реакцию на этот разрыв. С конкретным человеком, в конкретный день. Формат: что сделает + кому + когда.`,
      },
      {
        id: 'intent',
